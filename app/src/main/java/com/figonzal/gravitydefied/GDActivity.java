...
import com.figonzal.gravitydefied.Game.*;
import com.figonzal.gravitydefied.Levels.Loader;
import com.figonzal.gravitydefied.R;
import com.figonzal.gravitydefied.Menu.Views.MenuHelmetView;
...
import com.figonzal.gravitydefied.Menu.Views.MenuTitleLinearLayout;
import com.figonzal.gravitydefied.Menu.Views.ObservableScrollView;
...
public class GDActivity extends Activity implements Runnable {
	...
	public com.figonzal.gravitydefied.Menu.Menu menu;
	...
	public void run() {
		...
		if (!inited) {
			...
			try {
				...
				menu = new com.figonzal.gravitydefied.Menu.Menu();
				// menu = null;
				// menu.hideKeyboard();
				for (int i = 1; i <= 4; i++) {
					menu.load(i);
		...
		Thread statsThread = new Thread() {
			...
			public void run() {
				try {
					...
					int useCheats = com.figonzal.gravitydefied.Menu.Menu.isNameCheat(Settings.getName()) ? 1 : 0;
