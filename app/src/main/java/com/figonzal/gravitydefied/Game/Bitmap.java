...
public class Bitmap {
	...
	public int getWidthDp() {
		return Math.round(getWidth() / getGDActivity().getResources().getDisplayMetrics().density);
	}

	public int getHeightDp() {
		return Math.round(getHeight() / getGDActivity().getResources().getDisplayMetrics().density);
	}
